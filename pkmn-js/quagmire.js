...
addEvent(new SignPost({
	...
	infodex_entry: new InfodexEntry({
		title: "The Anarchy Quagmire",
		html: "<h3>Ice Path</h3><p>Ice puzzles are not easy for TPP, even with half the people knowing what path needs to be taken. One wrong move will send us flying across the puzzle to a point of no return, and with the lag and delibrate trolling, ice puzzles are tough. Pryce's gym deserves special mention in this regard, though he only took a couple attempt, the amount of time it took to try again lead to us being stuck there for many many hours.</p>",
	}),
}));
addEvent(new SignPost({
	name : "PC Sign",
...
addEvent(new SignPost({
	...
	x: 204, y:-245,
	sprite: 2,
	message: "In memory of a worthy foe: Morty's Gym: The Unseen Path.",
...
addEvent(new SignPost({
	...
	x: 208, y:-245,
	sprite: 2,
	message: "In memory of a worthy foe: Relic Castle: The Quicksand Traps.",
